...
misp_base_url = "https://misppriv.circl.lu/attributes/restSearch/"
# MISP Server API AUTH KEY
misp_api_auth_key = "MYKEY"
# API - HTTP Headers
...
if event_source == 'windows':
    ...
    try:
        ...
        with open('/var/ossec/integrations/log.txt','w') as f:
            f.write(str(misp_api_response))
